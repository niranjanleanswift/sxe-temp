...
/**
 * Class BindCustomerPriceonListingLoadObserver
 * @package LeanSwift\Econnect\Observer\CustomerPrice
 */
class BindCustomerPriceonListingLoadObserver implements ObserverInterface
{
    /**
     * Econnect helper
     *
    ...
    /**
     * Binds the customer price on loading the listing page
     *
